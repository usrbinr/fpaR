...
#>  .. ..  .. .. .. .. ..@ dbdir       : chr "/tmp/Rtmpkn0GlH/file60a617c1ade1"
...
#>  .. @ new_column_name_vec: chr "qoq_quantity"
#>  .. @ new_column_name_quo: symbol qoq_quantity
#>  @ fn       : <fpaR::fn>
#>  .. @ fn_exec             : function (x)  
#>  .. @ fn_name             : chr "qoq"
#>  .. @ fn_long_name        : chr "Quarter over quarter"
#>  .. @ shift               : chr "quarter"
...
#>  .. @ method: chr "This creates a full quarter {.code sum()} of the {cli::col_br_cyan('previous quarter')}\n                      "| __truncated__
```
