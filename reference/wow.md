...
#>  .. ..  .. .. .. .. ..@ dbdir       : chr "/tmp/Rtmpkn0GlH/file60a67a03d017"
...
#>  .. @ new_column_name_vec: chr "wow_quantity"
#>  .. @ new_column_name_quo: symbol wow_quantity
#>  @ fn       : <fpaR::fn>
#>  .. @ fn_exec             : function (x)  
#>  .. @ fn_name             : chr "wow"
#>  .. @ fn_long_name        : chr "week over week"
#>  .. @ shift               : chr "week"
#>  .. @ compare             : chr "previous week"
#>  .. @ label               : logi FALSE
#>  .. @ new_date_column_name: chr [1:4] "date" "week" "year" "month"
#>  .. @ lag_n               : num 1
#>  @ action   : <fpaR::action>
#>  .. @ value :List of 5
...
#>  .. @ method: chr "This creates a full week {.code sum()} of the {cli::col_br_cyan('previous week')}\n                            "| __truncated__
```
