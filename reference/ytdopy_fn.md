...
[`ytdopy()`](https://usrbinr.github.io/fpaR/reference/ytdopy.md) when
passed through to
...
will return a dbi object that can converted to a tibble object
with[`dplyr::collect()`](https://dplyr.tidyverse.org/reference/compute.html)

## See also

[`ytdopy()`](https://usrbinr.github.io/fpaR/reference/ytdopy.md) for the
function's intent
