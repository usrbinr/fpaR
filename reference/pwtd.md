...
``` r
pwtd(.data, .date, .value, calendar_type, lag_n)
```
...
#>  .. ..  .. .. .. .. ..@ dbdir       : chr "/tmp/Rtmpkn0GlH/file60a62c6f9740"
...
#>  .. @ new_column_name_vec: chr "pwtd_quantity"
#>  .. @ new_column_name_quo: symbol pwtd_quantity
#>  @ fn       : <fpaR::fn>
#>  .. @ fn_exec             : function (x)  
#>  .. @ fn_name             : chr "pwtd"
#>  .. @ fn_long_name        : chr "Previous Week-to-date"
#>  .. @ shift               : chr "week"
#>  .. @ compare             : chr NA
#>  .. @ label               : logi FALSE
...
#>  .. @ method: chr "This creates a daily {.code cumsum()} of the {cli::col_br_cyan('previous week')}\n                             "| __truncated__
```
