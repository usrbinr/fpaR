...
``` r
pmtd(.data, .date, .value, calendar_type, lag_n)
```
...
#>  .. ..  .. .. .. .. ..@ dbdir       : chr "/tmp/Rtmpkn0GlH/file60a6225f23fc"
...
#>  .. @ new_column_name_vec: chr "pmtd_quantity"
#>  .. @ new_column_name_quo: symbol pmtd_quantity
#>  @ fn       : <fpaR::fn>
#>  .. @ fn_exec             : function (x)  
#>  .. @ fn_name             : chr "pmtd"
#>  .. @ fn_long_name        : chr "Previous month-to-date"
#>  .. @ shift               : chr "month"
#>  .. @ compare             : chr NA
#>  .. @ label               : logi FALSE
