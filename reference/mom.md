...
``` r
mom(.data, .date, .value, calendar_type, lag_n = 1)
```
...
#>  .. ..  .. .. .. .. ..@ dbdir       : chr "/tmp/Rtmpkn0GlH/file60a679d03fe1"
...
#>  .. @ new_column_name_vec: chr "mom_quantity"
#>  .. @ new_column_name_quo: symbol mom_quantity
#>  @ fn       : <fpaR::fn>
#>  .. @ fn_exec             : function (x)  
#>  .. @ fn_name             : chr "mom"
#>  .. @ fn_long_name        : chr "Month over month"
#>  .. @ shift               : chr "month"
#>  .. @ compare             : chr "previous full month"
#>  .. @ label               : logi FALSE
...
#>  .. @ method: chr "This creates a full month {.code sum()} of the {cli::col_br_cyan('previous month')}\n                          "| __truncated__
```
