...
``` r
wowtd(.data, .date, .value, calendar_type, lag_n)
```
...
#>  .. ..  .. .. .. .. ..@ dbdir       : chr "/tmp/Rtmpj7avaG/file5c13569dc53c"
...
#>  .. @ new_column_name_vec: chr "wowtd_quantity"
#>  .. @ new_column_name_quo: symbol wowtd_quantity
#>  @ fn       : <fpaR::fn>
#>  .. @ fn_exec             : function (x)  
#>  .. @ fn_name             : chr "wowtd"
#>  .. @ fn_long_name        : chr "Week-to-date over previous week-to-date"
#>  .. @ shift               : chr "week"
#>  .. @ compare             : chr "pwtd"
#>  .. @ label               : logi FALSE
