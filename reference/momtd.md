...
``` r
momtd(.data, .date, .value, calendar_type, lag_n)
```
...
#>  .. ..  .. .. .. .. ..@ dbdir       : chr "/tmp/RtmpKEPn4a/file5c0634299308"
...
#>  .. @ new_column_name_vec: chr "momtd_quantity"
#>  .. @ new_column_name_quo: symbol momtd_quantity
#>  @ fn       : <fpaR::fn>
#>  .. @ fn_exec             : function (x)  
#>  .. @ fn_name             : chr "momtd"
#>  .. @ fn_long_name        : chr "Month-to-date over previous month-to-date"
#>  .. @ shift               : chr "month"
#>  .. @ compare             : chr "Previous month-to-date"
#>  .. @ label               : logi FALSE
...
#>  .. @ method: chr "This creates a daily {.code cumsum()} of the {cli::col_br_cyan('previous month')}\n                            "| __truncated__
```
