...
``` r
wtd(.data, .date, .value, calendar_type)
```
...
#>  .. ..  .. .. .. .. ..@ dbdir       : chr "/tmp/Rtmpj7avaG/file5c13417096a2"
...
#>  .. @ new_column_name_vec: chr "wtd_quantity"
#>  .. @ new_column_name_quo: symbol wtd_quantity
#>  @ fn       : <fpaR::fn>
#>  .. @ fn_exec             : function (x)  
#>  .. @ fn_name             : chr "wtd"
#>  .. @ fn_long_name        : chr "Week-to-date"
#>  .. @ shift               : chr NA
#>  .. @ compare             : chr NA
#>  .. @ label               : logi FALSE
