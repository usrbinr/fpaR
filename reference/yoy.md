...
- This calculates the full year value compared to the previous year
  value respecting any groups that are passed through with
...
``` r
yoy(.data, .date, .value, calendar_type, lag_n = 1)
```
...
#>  .. ..  .. .. .. .. ..@ dbdir       : chr "/tmp/Rtmpj7avaG/file5c1365a922e2"
...
#>  .. @ new_column_name_vec: chr "yoy_quantity"
#>  .. @ new_column_name_quo: symbol yoy_quantity
#>  @ fn       : <fpaR::fn>
#>  .. @ fn_exec             : function (x)  
#>  .. @ fn_name             : chr "yoy"
