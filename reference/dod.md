...
``` r
dod(.data, .date, .value, calendar_type, lag_n = 1)
```
...
#>  .. ..  .. .. .. .. ..@ dbdir       : chr "/tmp/Rtmpj7avaG/file5c1326b8623a"
...
#>  .. @ new_column_name_vec: chr "dod_quantity"
#>  .. @ new_column_name_quo: symbol dod_quantity
#>  @ fn       : <fpaR::fn>
#>  .. @ fn_exec             : function (x)  
#>  .. @ fn_name             : chr "dod"
#>  .. @ fn_long_name        : chr "Day over day"
#>  .. @ shift               : chr "day"
#>  .. @ compare             : chr "previous day"
#>  .. @ label               : logi FALSE
...
#>  .. @ method: chr "This creates a full day {.code sum()} of the {cli::col_br_cyan('previous day')}\n                             {"| __truncated__
```
