...
``` r
wtdopw(.data, .date, .value, calendar_type, lag_n)
```
...
#>  .. ..  .. .. .. .. ..@ dbdir       : chr "/tmp/Rtmpkn0GlH/file60a64090b270"
...
#>  .. @ new_column_name_vec: chr "wtwopw_quantity"
#>  .. @ new_column_name_quo: symbol wtwopw_quantity
#>  @ fn       : <fpaR::fn>
#>  .. @ fn_exec             : function (x)  
#>  .. @ fn_name             : chr "wtdopw"
#>  .. @ fn_long_name        : chr "Week-to-date over full previous week"
#>  .. @ shift               : chr "week"
#>  .. @ compare             : chr "previous week"
#>  .. @ label               : logi FALSE
#>  .. @ new_date_column_name: chr [1:4] "date" "year" "month" "week"
#>  .. @ lag_n               : num 1
#>  @ action   : <fpaR::action>
#>  .. @ value :List of 5
...
#>  .. @ method: chr "This creates a daily {.code cumsum()} of the {cli::col_cyan('current week')}\n                             {.fi"| __truncated__
```
