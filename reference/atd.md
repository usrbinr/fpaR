...
#>  .. ..  .. .. .. .. ..@ dbdir       : chr "/tmp/Rtmpj7avaG/file5c1334cb089b"
...
#>  .. @ new_column_name_vec: chr "atd_quantity"
#>  .. @ new_column_name_quo: symbol atd_quantity
#>  @ fn       : <fpaR::fn>
#>  .. @ fn_exec             : function (x)  
#>  .. @ fn_name             : chr "atd"
#>  .. @ fn_long_name        : chr "All-to-date"
#>  .. @ shift               : chr NA
#>  .. @ compare             : chr NA
#>  .. @ label               : logi FALSE
#>  .. @ new_date_column_name: chr "date"
#>  .. @ lag_n               : int NA
#>  @ action   : <fpaR::action>
#>  .. @ value :List of 5
...
#>  .. @ method: chr "This creates a daily {.code cumsum()}\n                             {.field {value_chr}} from the earliest date"| __truncated__
```
