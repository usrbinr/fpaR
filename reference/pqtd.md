...
``` r
pqtd(.data, .date, .value, calendar_type, lag_n)
```
...
#>  .. ..  .. .. .. .. ..@ dbdir       : chr "/tmp/RtmpKEPn4a/file5c0616c4ec3f"
...
#>  .. @ new_column_name_vec: chr "pqtd_quantity"
#>  .. @ new_column_name_quo: symbol pqtd_quantity
#>  @ fn       : <fpaR::fn>
#>  .. @ fn_exec             : function (x)  
#>  .. @ fn_name             : chr "pqtd"
#>  .. @ fn_long_name        : chr "Prior quarter-to-date"
#>  .. @ shift               : chr "quarter"
#>  .. @ compare             : chr NA
#>  .. @ label               : logi FALSE
#>  .. @ new_date_column_name: chr [1:3] "date" "year" "quarter"
#>  .. @ lag_n               : num 1
#>  @ action   : <fpaR::action>
#>  .. @ value :List of 5
...
#>  .. @ method: chr "This creates a daily {.code cumsum()} of the {cli::col_br_cyan('previous quarter')}\n                          "| __truncated__
```
