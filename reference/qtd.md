...
``` r
qtd(.data, .date, .value, calendar_type)
```
...
#>  .. ..  .. .. .. .. ..@ dbdir       : chr "/tmp/RtmpKEPn4a/file5c0662aced71"
...
#>  .. @ new_column_name_vec: chr "qtd_quantity"
#>  .. @ new_column_name_quo: symbol qtd_quantity
#>  @ fn       : <fpaR::fn>
#>  .. @ fn_exec             : function (x)  
#>  .. @ fn_name             : chr "qtd"
#>  .. @ fn_long_name        : chr "Quarter-to-date"
#>  .. @ shift               : chr NA
#>  .. @ compare             : chr NA
#>  .. @ label               : logi FALSE
#>  .. @ new_date_column_name: chr [1:2] "year" "quarter"
#>  .. @ lag_n               : int NA
#>  @ action   : <fpaR::action>
#>  .. @ value :List of 5
...
#>  .. @ method: chr "This creates a daily {.code cumsum()} of the {cli::col_cyan('current quarter')}\n                              "| __truncated__
```
