...
`mom_fn()` is the function that is called by
[`mom()`](https://usrbinr.github.io/fpaR/reference/mom.md) when passed
through to
...
[`mom()`](https://usrbinr.github.io/fpaR/reference/mom.md) for the
function's intent
